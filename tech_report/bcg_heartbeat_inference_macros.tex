...
\newcommand{\rbtransmat}{A}                     % Parameter transition matrix for Rao-Blackwellisable models
\newcommand{\rbtranscov}{Q}                     % Parameter covariance matrix for Rao-Blackwellisable models
\newcommand{\obsmat}{H}                         % Observation matrix
\newcommand{\rbobscov}{R}                         % Observation covariance matrix 
...
\newcommand{\hs}[2]{x_{#1}(#2)}                 % Heartbeat signal
...
\newcommand{\obscov}[1][]{\sigma_y^2 I}                 % Observation covariance
