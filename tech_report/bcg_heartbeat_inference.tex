...
\begin{IEEEeqnarray}{rCl}
 \cp[\ti_1]{\ti_2} = \{\cpt{j}, \cpp{j} \: \forall j : \ot{\ti_1} < \cpt{j} \leq \ot{\ti_2} \} \nonumber      ,
\end{IEEEeqnarray}
%
and likewise for the set occurring before a given instant,
%
\begin{IEEEeqnarray}{rCl}
 \cp{\ti} = \{\cpt{j}, \cpp{j} \: \forall j : \cpt{j} \leq \ot{\ti} \} \nonumber      .
\end{IEEEeqnarray}
...
%
\begin{IEEEeqnarray}{rCl}
 \left\{ \cpt{1:\mrcpi_{1}}, \cpp{1:\mrcpi_{1}} \right\} & \sim & \cptransden{\cpt{},\cpp{}}(\cpt{1:\mrcpi_{1}}, \cpp{1:\mrcpi_{1}}) \nonumber      ,
\end{IEEEeqnarray}
%
...
%
\begin{IEEEeqnarray}{rCl}
 \survfunc{\cpt{1:\cpi}}{\cpp{1:\cpi}}{\ct} & = & \prob(\cpt{\cpi+1} > \ct | \cpt{1:\cpi}, \cpp{1:\cpi}) \nonumber \\
 & = & 1 - \int_{\cpt{\cpi}}^{\ct} \cptransden{\cpt{}}(\xi | \cpt{1:\cpi}, \cpp{1:\cpi}) \nonumber      .
\end{IEEEeqnarray}
...
%
\begin{IEEEeqnarray}{rCl}
 \cptransden{\cp{}}(\cp[\ti_1]{\ti_2} | \cp{\ti_1})  & = & \frac{ \survfunc{\cpt{1:\mrcpi_{\ti_2}}}{\cpp{1:\mrcpi_{\ti_2}}}{\ot{\ti_2}} }{ \survfunc{\cpt{1:\mrcpi_{\ti_1}}}{\cpp{1:\mrcpi_{\ti_1}}}{\ot{\ti_1}} } \prod_{\cpi=\mrcpi_{\ti_1}+1}^{\mrcpi_{\ti_2}} \cptransden{\cpt{},\cpp{}}(\cpt{\cpi}, \cpp{\cpi} | \cpt{1:\cpi-1}, \cpp{1:\cpi-1}) \nonumber       .
 %& = & \cptransden{\cpt{},\cpp{}}(\cpt{\mrcpi_{\ti_1}+1}, \cpp{\mrcpi_{\ti_1}+1} | \cpt{0:\cpi-1}, \cpp{0:\cpi-1}, \cpt{\mrcpi_{\ti_1}+1}>\ot{\ti_1}) \prod_{\cpi=\mrcpi_{\ti_1}+1}^{\mrcpi_{\ti_2}} \cptransden{\cpt{},\cpp{}}(\cpt{\cpi}, \cpp{\cpi} | \cpt{0:\cpi-1}, \cpp{0:\cpi-1}) \prob(\cpt{\mrcpi_{\ti_2}+1}>\ot{\ti_2}) \nonumber \\
\end{IEEEeqnarray}
%
We also have the following prior for $\cp{1}$,
%
\begin{IEEEeqnarray}{rCl}
 \cptransden{\cp{}}(\cp{1}) & = & \cptransden{\cpt{},\cpp{}}(\cpt{1:\mrcpi_{1}}, \cpp{1:\mrcpi_{1}} | \cpt{\mrcpi_{1}+1:\fcpi}>0) \nonumber      .
\end{IEEEeqnarray}
%
Together, these give us the prior distribution for a complete sequence,
%
\begin{IEEEeqnarray}{rCl}
 \cptransden{\cp{}}(\cp{\ti}) & = & \cptransden{\cp{}}(\cp[1]{\ti} | \cp{1}) \cptransden{\cp{}}(\cp{1}) \nonumber \\
 & = & \frac{ \survfunc{\cpt{1:\mrcpi_{\ti}}}{\cpp{1:\mrcpi_{\ti}}}{\ot{\ti}} }{ \survfunc{\cpt{1:\mrcpi_{1}}}{\cpp{1:\mrcpi_{1}}}{\ot{1}} } \cptransden{\cpt{},\cpp{}}(\cpt{1:\mrcpi_{1}},\cpp{1:\mrcpi_{1}} | \cpt{\mrcpi_{1}:\fcpi}>0) \prod_{\cpi=\mrcpi_{1}+1}^{\mrcpi_{\ti}} \cptransden{\cpt{},\cpp{}}(\cpt{\cpi}, \cpp{\cpi} | \cpt{0:\cpi-1}, \cpp{0:\cpi-1}) \nonumber      .
\end{IEEEeqnarray}
...
%%
%\begin{IEEEeqnarray}{rCl}
% \left\{ \cpt{0}, \cpp{0} \right\} & \sim & \cptransden{\cpt{},\cpp{}}(\cpt{0}, \cpp{0}) \nonumber      ,
%\end{IEEEeqnarray}
%%
...
%%
%\begin{IEEEeqnarray}{rCl}
% \cptransden{\cp{}}(\cp[\ti_1]{\ti_2} | \cp{\ti_1})  & = & \frac{ \survfunc{\cpt{0:\mrcpi_{\ti_2}}}{\cpp{0:\mrcpi_{\ti_2}}}{\ot{\ti_2}} }{ \survfunc{\cpt{0:\mrcpi_{\ti_1}}}{\cpp{0:\mrcpi_{\ti_1}}}{\ot{\ti_1}} } \prod_{\cpi=\mrcpi_{\ti_1}+1}^{\mrcpi_{\ti_2}} \cptransden{\cpt{},\cpp{}}(\cpt{\cpi}, \cpp{\cpi} | \cpt{0:\cpi-1}, \cpp{0:\cpi-1}) \nonumber       .
% %& = & \cptransden{\cpt{},\cpp{}}(\cpt{\mrcpi_{\ti_1}+1}, \cpp{\mrcpi_{\ti_1}+1} | \cpt{0:\cpi-1}, \cpp{0:\cpi-1}, \cpt{\mrcpi_{\ti_1}+1}>\ot{\ti_1}) \prod_{\cpi=\mrcpi_{\ti_1}+1}^{\mrcpi_{\ti_2}} \cptransden{\cpt{},\cpp{}}(\cpt{\cpi}, \cpp{\cpi} | \cpt{0:\cpi-1}, \cpp{0:\cpi-1}) \prob(\cpt{\mrcpi_{\ti_2}+1}>\ot{\ti_2}) \nonumber \\
%\end{IEEEeqnarray}
%%
...
%%
%\begin{IEEEeqnarray}{rCl}
% \cptransden{\cp{}}(\cp{1}) & = & \cptransden{\cpt{},\cpp{}}(\cpt{0}, \cpp{0} | \cpt{1}>0) \nonumber      .
%\end{IEEEeqnarray}
%%
%Together, these give us the prior distribution for a complete sequence,
%%
%\begin{IEEEeqnarray}{rCl}
% \cptransden{\cp{}}(\cp{\ti}) & = & \cptransden{\cp{}}(\cp[1]{\ti} | \cp{1}) \cptransden{\cp{}}(\cp{1}) \nonumber \\
% & = & \frac{ \survfunc{\cpt{0:\mrcpi_{\ti}}}{\cpp{0:\mrcpi_{\ti}}}{\ot{\ti}} }{ \survfunc{\cpt{0}}{\cpp{0}}{0} } \cptransden{\cpt{},\cpp{}}(\cpt{0},\cpp{0} | \cpt{1}>0) \prod_{\cpi=1}^{\mrcpi_{\ti}} \cptransden{\cpt{},\cpp{}}(\cpt{\cpi}, \cpp{\cpi} | \cpt{0:\cpi-1}, \cpp{0:\cpi-1}) \nonumber      .
%\end{IEEEeqnarray}


%We can write the the following prior distribution for the changepoint sequence,
%%
%\begin{IEEEeqnarray}{rCl}
% \cptransden{\cp{}}(\cp{\ti}) & = & \frac{ \survfunc{\cpt{0:\mrcpi_{\ti}}}{\cpp{0:\mrcpi_{\ti}}}{\ot{\ti}} }{ \survfunc{\cpt{0}}{\cpp{0}}{0} } \cptransden{\cpt{},\cpp{}}(\cpt{0},\cpp{0}) \prod_{\cpi=1}^{\mrcpi_{\ti}} \cptransden{\cpt{},\cpp{}}(\cpt{\cpi}, \cpp{\cpi} | \cpt{0:\cpi-1}, \cpp{0:\cpi-1}) \nonumber      ,
%\end{IEEEeqnarray}
%%
...
\begin{IEEEeqnarray}{rClCrCl}
 \left\{\cpt{\cpi}\right\} & = & \left\{\hbst[1]{\cpi_1}\right\} \bigcup \left\{\hbst[2]{\cpi_2}\right\} & \qquad & \left\{\cpp{\cpi}\right\} & = & \left\{\begin{bmatrix} \hbmd[1]{\cpi_1} \\ \peri_{\cpi_1} \end{bmatrix}\right\} \bigcup \left\{\begin{bmatrix} \hbmd[2]{\cpi_2} \\ \peri_{\cpi_2} \end{bmatrix}\right\} \nonumber \\
  \nonumber \\
