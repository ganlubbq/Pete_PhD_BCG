...
\begin{IEEEeqnarray}{l}
 \impden{\ti}{\ti+\winlen}(\cp[\ti]{\ti+\winlen}, \tmpcpt[1]{\dmrcpi[1]{\ti}+1:\dmrcpi[1]{\ti+\winlen}}, \tmpcpt[2]{\dmrcpi[2]{\ti}+1:\dmrcpi[2]{\ti+\winlen}}, \dots | \cp{\ti-\blocklen+\winlen}) = \prod_{\sqi}\left[ \frac{ \survfunc[\sqi]{\cpt[\sqi]{\dmrcpi[\sqi]{\ti_2}}}{\cpp[\sqi]{\dmrcpi[\sqi]{\ti_2}}}{\ot{\ti_2}} }{ \survfunc[\sqi]{\cpt[\sqi]{\dmrcpi[\sqi]{\ti_1}}}{\cpp[\sqi]{\dmrcpi[\sqi]{\ti_1}}}{\ot{\ti_1}} } \right] \nonumber \\
 \qquad  \times \prod_{l=1}^{\diffcpi{1}} \left[\prod_{\sqi} \transden[\sqi]{\cpt{},\cpp{}}\left(\tmpcpt[\sqi]{\dmrcpi[\sqi]{\ti_1}+l}, \cpp[\sqi]{\dmrcpi[\sqi]{\ti_1}+l} \left| \cpt[\sqi]{\dmrcpi[\sqi]{\ti_1}+l-1}, \cpp[\sqi]{\dmrcpi[\sqi]{\ti_1}+l-1}\right.\right) \right] \nonumber \\
 \qquad \qquad \qquad \qquad \qquad \qquad\times \adjden \left( \cpt[1]{\dmrcpi[1]{\ti_1}+l}, \cpt[2]{\dmrcpi[2]{\ti_1}+l} \left| \tmpcpt[1]{\dmrcpi[1]{\ti_1}+l}, \tmpcpt[2]{\dmrcpi[2]{\ti_1}+l} \right.\right) \nonumber \\
...
%
\begin{IEEEeqnarray}{c}
 p\left(\cp{\ti}, \repcp[\ti]{\ti+\winlen} | \ob{1:\ti+\winlen}\right) \artden{\ti}{\ti-\blocklen+\winlen}\left( \cp[\ti]{\ti-\blocklen+\winlen} | \cp{\ti}, \repcp[\ti]{\ti+\winlen}\right) \nonumber \\
 \qquad \qquad \times \tmpden\left( \tmpcpt[1]{\dmrcpi[1]{\ti}+1:\dmrcpi[1]{\ti+\winlen}}, \tmpcpt[2]{\dmrcpi[2]{\ti}+1:\dmrcpi[2]{\ti+\winlen}}, \dots | \cp{\ti}, \repcp[\ti]{\ti+\winlen} \right) \nonumber      .
\end{IEEEeqnarray}
%
A simple choice is to use the transition distribution for both $\artden{}{}$ (as before) and $\tmpden$,
%
\begin{IEEEeqnarray}{l}
 \tmpden\left( \tmpcpt[1]{\dmrcpi[1]{\ti}+1:\dmrcpi[1]{\ti+\winlen}}, \tmpcpt[2]{\dmrcpi[2]{\ti}+1:\dmrcpi[2]{\ti+\winlen}}, \dots | \cp{\ti}, \repcp[\ti]{\ti+\winlen} \right) \nonumber \\
 \qquad \qquad \qquad = \prod_{\sqi} \prod_{\cpi=\dmrcpi[\sqi]{\ti_1}+1}^{\dmrcpi[\sqi]{\ti_2}} \transden[\sqi]{\cpt{}}\left(\tmpcpt[\sqi]{\cpi} | \cpt[\sqi]{\cpi-1}, \cpp[\sqi]{\cpi-1}\right) \nonumber      ,
\end{IEEEeqnarray}
%
...
\begin{IEEEeqnarray}{l}
 ...
 \qquad \times \frac{ \prod_{\sqi} \prod_{\cpi=\dmrcpi[\sqi]{\ti_1}+1}^{\dmrcpi[\sqi]{\ti_2}} \transden[\sqi]{\cpt{}}\left(\cpt[\sqi]{\cpi} | \cpt[\sqi]{\cpi-1}, \cpp[\sqi]{\cpi-1}\right) }{ \prod_{l=1}^{\diffcpi{1}} \adjden \left( \cpt[1]{\dmrcpi[1]{\ti_1}+l}, \cpt[2]{\dmrcpi[2]{\ti_1}+l} \left| \tmpcpt[1]{\dmrcpi[1]{\ti_1}+l}, \tmpcpt[2]{\dmrcpi[2]{\ti_1}+l} \right.\right) \prod_{l=\diffcpi{1}+1}^{\diffcpi{2}} \adjden \left( \cpt[2]{\dmrcpi[2]{\ti_1}+l} \left| \tmpcpt[2]{\dmrcpi[2]{\ti_1}+l} \right.\right) } \nonumber       .
\end{IEEEeqnarray}
