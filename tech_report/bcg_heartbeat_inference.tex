...
\begin{IEEEeqnarray}{rCl}
 \cp{\ti} = \{\cpt{j}, \cpp{j} \: \forall j : 0 \leq \cpt{j} < \ot{\ti} \} \nonumber      ,
\end{IEEEeqnarray}
%
...
\begin{IEEEeqnarray}{rCll}
 \cls{\ct} & = & \transfun\left( \cls{\ot{\mrcpi(\ct)}}, \cpt{\mrcpi(\ct)}, \cpp{\mrcpi(\ct)}, \ct \right) & , \qquad \cpt{\mrcpi(\ct)} < \ct \leq \cpt{\mrcpi(\ct) + 1} \nonumber      .
\end{IEEEeqnarray}
...
%
\begin{IEEEeqnarray}{rCl}
 \lhood(\ob{\ti_1:\ti_2} | \cp{\ti_2}) & = & \prod_{l} \lhood(\ob{l} | \cls{\ot{\ti}}) \nonumber       ,
\end{IEEEeqnarray}
...
%
\begin{IEEEeqnarray}{rCl}
 \pw{\ti}\pss{i} & \propto & \frac{ \lhood(\ob{\ti:\ti+\winlen} | \cp{\ti}\pss{i}, \repcp[\ti]{\ti+\winlen}\pss{i}) }{ \lhood(\ob{\ti:\ti-\blocklen+\winlen} | \cp{\ti-\blocklen+\winlen}\pss{i}) } \nonumber       .
\end{IEEEeqnarray}
...
%
\begin{IEEEeqnarray}{rCl}
 \intrp_{i}(\hbst{\mrcpi(\ct)},\ct) & = & \sinc\left( \frac{\ct-\hbst{\mrcpi(\ct)}- i \period}{\period} \right) \nonumber     ,
\end{IEEEeqnarray}
%
