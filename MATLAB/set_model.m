...
% Basics
model.K = 3600;              % Number of observations
...
% Transition models
model.tau_trans_scale = 3E-2; %3E-2           % Changepoint time transition density (gamma) scale (shape is given by p/scale)
model.p_trans_scale = 1E-3;   %1E-5           % Beat period transition density (gamms) scale (shape is the previous value/scale)
